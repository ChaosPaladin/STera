...
public enum ClientPacketType
{
    ...
    {
    	// создаем фильтр дубликатов
        HashSet<Integer> set = new HashSet<Integer>();
        // получаем набор енум элементов
