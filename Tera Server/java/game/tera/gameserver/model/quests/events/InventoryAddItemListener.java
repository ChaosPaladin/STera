 ...
 * @author Ronn
 */
public class InventoryAddItemListener extends AbstractQuestEventListener
{
	/** нужный ид итема */
	private int id;
	
	public InventoryAddItemListener(QuestEventType type, QuestAction[] actions, Quest quest, Node node)
	{
