 ...
 * @author Ronn
 */
public class InventoryRemoveItemListener extends AbstractQuestEventListener
{
	/** нужный ид итема */
	private int id;
	
	public InventoryRemoveItemListener(QuestEventType type, QuestAction[] actions, Quest quest, Node node)
	{
